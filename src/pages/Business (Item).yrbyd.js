...
$w.onReady(async function () {
    ...
    if (wixMembersFrontend.authentication.loggedIn()) {
        ...
        await $w('#productByBusiness').onReadyAsync()
        let currentItem = $w('#productByBusiness').getCurrentItem()
        let business = currentItem._id
